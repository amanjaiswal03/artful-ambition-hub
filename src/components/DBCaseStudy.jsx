  ...
  return (
    <div className="box-border content-stretch flex flex-row items-start justify-between px-14 py-8 relative size-full">
      <div className="box-border content-stretch flex flex-row font-['Helvetica_Neue:Medium',_sans-serif] gap-4 items-center justify-start leading-[0] not-italic p-0 relative shrink-0 text-[20px] text-left">
        <div className="relative shrink-0 text-[#8a8a8a] w-[157px]"><p className="block leading-[32px]">Sonja Weissberg</p></div>
        <div className="relative shrink-0 text-[#000000] w-[164px]"><p className="block leading-[32px]">Product Designer</p></div>
      </div>
      <div className="bg-[#e9e9e9] box-border content-stretch flex flex-row gap-px h-11 items-center justify-center p-0 relative rounded-[13px] shrink-0 w-[181px]">
        <div className="font-['Helvetica_Neue:Medium',_sans-serif] h-8 leading-[0] not-italic relative shrink-0 text-[#8e8e8e] text-[18px] text-left w-28"><p className="block leading-[32px]">Case Studies</p></div>
        <button onClick={onBackToHome} className="relative shrink-0 size-8 flex items-center justify-center rounded-md hover:bg-black/5" aria-label="Back">
...
export default function DBCaseStudy({ onBackToHome }) {
  return (
